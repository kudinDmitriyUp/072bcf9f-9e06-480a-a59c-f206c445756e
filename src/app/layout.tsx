...
export const metadata: Metadata = {
  title: "Creative Director & Designer Portfolio | Strategic Brand Design",
  description: "Award-winning creative director specializing in brand strategy, visual design, and creative direction. Transform your brand with compelling visual narratives.",
  keywords: "creative director, brand design, visual design, creative strategy, portfolio, branding, graphic design",
  metadataBase: new URL("https://creativedirector.portfolio"),
  alternates: {
    canonical: "https://creativedirector.portfolio"
  },
  openGraph: {
    title: "Creative Director & Designer Portfolio",
    description: "Crafting compelling visual narratives and brand experiences that drive meaningful connections",
    url: "https://creativedirector.portfolio",
    siteName: "Creative Director Portfolio",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35a7P1i3U8nbKvxlC9pMeozlemI/uploaded-1763336371931-q4m0afgp.jpg",
  ...
  twitter: {
    ...
    title: "Creative Director & Designer Portfolio",
    description: "Transform your brand with strategic creative direction and exceptional design",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35a7P1i3U8nbKvxlC9pMeozlemI/uploaded-1763336371931-q4m0afgp.jpg"]
  },
  robots: {
    index: true,
    follow: true
